...
def download_nuclear_data():
    ...
    os.environ["OPENMC_CROSS_SECTIONS"] = str(data_dir / "endfb-vii.1-hdf5" / "cross_sections.xml")
...
def get_results_context(latest_dataset):
    if latest_dataset == "smoke":
        ...
        return "This plot shows the neutron flux from the provided sample statepoint file."
...
def create_app():
        ...
        dcc.Tabs([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.P("Verify your installation by running the smoke test."),
                            html.Button('Run Smoke Test', id='run-smoke-test', n_clicks=0),
                            html.Hr(style={'margin': '10px 0'}),
                            html.H3("Analysis"),
                            html.P("Choose sample data or upload your own statepoint file."),
                            html.Div([
                                html.H4("Sample Data"),
                                html.P("Use pre-generated statepoint from OpenMC smoke test:"),
                                html.Button('Download Sample Data', id='download-sample', n_clicks=0),
                                html.Div(id='sample-data-status'),
                            ], style={'margin': '10px 0', 'padding': '10px', 'border': '1px solid #ddd', 'borderRadius': '5px'}),
                            html.Div([
                                html.H4("Upload Statepoint"),
                                html.P("Or upload your own statepoint file:"),
                                dcc.Upload(
                                    id='upload-data',
                                    children=html.Div([
                                        'Drag and Drop or ',
                        ...
                        html.Div([
                            html.H4("Output"),
                            html.Div(id='home-output-panel', style={'whiteSpace': 'pre-wrap', 'maxHeight': '400px', 'overflowY': 'auto'}),
                        ], style={'width': '35%', 'display': 'inline-block', 'verticalAlign': 'top', 'marginLeft': '2%', 'background': '#f9f9f9', 'padding': '10px', 'border': '1px solid #eee', 'borderRadius': '5px', 'minHeight': '300px'}),
            ...
            dcc.Tab(label='Results', children=[
                html.Div([
                    ...
                    html.Div(id='results-context', style={'marginBottom': '10px', 'fontStyle': 'italic', 'color': '#555'}),
                    ...
                    html.Div([
                        ...
                        html.Button('Export Results', id='export-results', n_clicks=0),
    ...
    def update_home_output(smoke_clicks, analysis_clicks, sample_clicks, uploaded_filename):
        ...
        if button_id == 'run-smoke-test':
            ...
            return html.Div([
                html.Div(summary, style={'fontWeight': 'bold', 'marginBottom': '8px'}),
                html.Pre(full_output, style={'background': '#f4f4f4', 'padding': '8px', 'borderRadius': '4px', 'fontSize': '12px'})
            ])
    ...
    def update_results_context(smoke_clicks, analysis_clicks, sample_clicks, upload_contents):
